...
f <- here("Rmd", "ieee", "figures", "worst-5-states-avg-sev.png")
kableExtra::save_kable(tbl_worst5_avg_sev %>% kable_styling(font_size = 24),f)
knitr::plot_crop(f)
...
x_cor <- cor(acc_state_day %>% select(n_acc, mean_sev, mean_precip, mean_temp))
corrplot(
  x_cor,
  type = "lower",
  addCoef.col = "black",
